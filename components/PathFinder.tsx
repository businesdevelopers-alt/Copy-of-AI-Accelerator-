        ...
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-10 text-center animate-fade-in-up border border-gray-100">
          {decision.decision === 'APPROVED' ? (
            <>
              ...
              <h2 className="text-3xl font-extrabold text-gray-900 mb-4">تهانينا! أنت مؤهل</h2>
              ...
              <button 
                onClick={onApproved}
                className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-brand-primary text-xl font-bold px-12 py-4 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all"
              >
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg transform rotate-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-brand-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="relative pt-1">
            ...
            <div className="overflow-hidden h-2 mb-1 text-xs flex rounded bg-indigo-100">
              <div 
                ...
                className="shadow-none flex flex-col text-center whitespace-nowrap text-brand-primary justify-center bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-1000 ease-out"
              ></div>
            </div>
          </div>
        </div>
        ...
        {messages.map((msg, idx) => (
          ...
          >
             <div className={`max-w-[85%] p-5 rounded-2xl shadow-sm text-lg leading-relaxed relative
               ${msg.role === 'user' 
                 ? 'bg-gradient-to-br from-blue-600 to-indigo-700 text-brand-primary rounded-br-none shadow-md' 
